        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedTotalAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FullAmountWith5PercentDiscount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FullAmountDueDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusFeePlans", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "EducationalFeePlans",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationalFeePlans", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "BusInstallments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusFeePlanId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BusInstallments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BusInstallments_BusFeePlans_BusFeePlanId",
                        column: x => x.BusFeePlanId,
                        principalTable: "BusFeePlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "EducationalInstallments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EducationalFeePlanId = table.Column<int>(type: "int", nullable: false),
                    Order = table.Column<int>(type: "int", nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DueDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EducationalInstallments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EducationalInstallments_EducationalFeePlans_EducationalFeePlanId",
                        column: x => x.EducationalFeePlanId,
                        principalTable: "EducationalFeePlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "StudentBusSubscriptions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentBusSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentBusSubscriptions_BusFeePlans_BusFeePlanId",
                        column: x => x.BusFeePlanId,
                        principalTable: "BusFeePlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentBusSubscriptions_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                name: "StudentEducationalPayments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    EducationalInstallmentId = table.Column<int>(type: "int", nullable: true),
                    IsFullPayment = table.Column<bool>(type: "bit", nullable: false),
                    PaymentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AmountPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PaymentStatus = table.Column<int>(type: "int", nullable: false),
                    PaymentStatusLastUpdate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TransactionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvoiceNumber = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentEducationalPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentEducationalPayments_EducationalInstallments_EducationalInstallmentId",
                        column: x => x.EducationalInstallmentId,
                        principalTable: "EducationalInstallments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentEducationalPayments_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "StudentBusPayments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusSubscriptionId = table.Column<int>(type: "int", nullable: false),
                    BusInstallmentId = table.Column<int>(type: "int", nullable: true),
                    IsFullPayment = table.Column<bool>(type: "bit", nullable: false),
                    PaymentDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AmountPaid = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    PaymentStatusLastUpdate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TransactionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvoiceNumber = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentBusPayments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentBusPayments_BusInstallments_BusInstallmentId",
                        column: x => x.BusInstallmentId,
                        principalTable: "BusInstallments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_StudentBusPayments_StudentBusSubscriptions_BusSubscriptionId",
                        column: x => x.BusSubscriptionId,
                        principalTable: "StudentBusSubscriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusInstallments_BusFeePlanId_Order",
                table: "BusInstallments",
                columns: new[] { "BusFeePlanId", "Order" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EducationalInstallments_EducationalFeePlanId_Order",
                table: "EducationalInstallments",
                columns: new[] { "EducationalFeePlanId", "Order" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentBusPayments_BusInstallmentId",
                table: "StudentBusPayments",
                column: "BusInstallmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentBusPayments_BusSubscriptionId",
                table: "StudentBusPayments",
                column: "BusSubscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentBusSubscriptions_BusFeePlanId",
                table: "StudentBusSubscriptions",
                column: "BusFeePlanId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentBusSubscriptions_StudentId",
                table: "StudentBusSubscriptions",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentEducationalPayments_EducationalInstallmentId",
                table: "StudentEducationalPayments",
                column: "EducationalInstallmentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentEducationalPayments_StudentId",
                table: "StudentEducationalPayments",
                column: "StudentId");
        }
