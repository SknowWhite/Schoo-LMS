...
@NgModule({
  providers: [
    ...
    ApiServiceProxies.StudentImportServiceProxy,
    ApiServiceProxies.EducationalPaymentServiceProxy,
    ...
    ApiServiceProxies.InstallmentService,
    ApiServiceProxies.StudentPaymentService,
