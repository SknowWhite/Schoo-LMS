...
import { EducationalPaymentServiceProxy, StudentPaymentDetails, StudentDTO } from '@shared/service-proxies/service-proxies';

@Component({
  selector: 'app-bus-fees',
  templateUrl: './bus-fees.component.html',
  styleUrl: './bus-fees.component.css'
})
export class BusFeesComponent extends AppComponentBase implements OnInit {
  studentId = 0;
  ...
  refreshPaymentData(): void {
    this._PaymentService.getBusPaymentData(this.studentId).subscribe((data: any) => {
